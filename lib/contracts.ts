...
export const WMON_ABI = [
  ...
  {
    // Wrap native MON -> WMON. WMON is WETH9-style; deposit() is payable and
    // mints WMON 1:1 for the MON sent as value. This is how hunted MON pays dues.
    name: "deposit",
    type: "function",
...
export const TURBO_GOVERNANCE_ADDRESS =
  "0x9e7A91D9F891373DD0846f443E4484EfA12c4899" as const;
...
export const TURBO_GOVERNANCE_ABI = [
  ...
  {
    name: "activeProposalForCohort",
    type: "function",
    stateMutability: "view",
    inputs: [{ name: "cohortId", type: "uint256" }],
    outputs: [{ name: "", type: "uint256" }],
  },
] as const;
...
export const PASSPORT_ADDRESS =
  "0x93126e59004692b01961be505aa04f55d5bd1851" as const;
...
export const TOURS_TOKEN_ADDRESS =
  "0x45b76a127167fD7FC7Ed264ad490144300eCfcBF" as const;
